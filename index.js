...
gsap.to("#page>video", {
    scrollTrigger: {
        trigger: `#page>video`,  // The trigger element for the animation
        start: `2% top`,        // The start position for the animation relative to the trigger
        end: `bottom top`,      // The end position for the animation relative to the trigger
       
        scroller: `#main` ,
    
    },
    onStart:()=>{
        document.querySelector("#page>video").play() // Function to play the video when the animation starts
    }
});
